...
const TAIWAN_LOCATIONS: Record<string, TaiwanLocationMeta> = {
  ...
  // 主要縣市
  '基隆': { datasetId: 'F-D0047-051', county: '基隆市', township: '仁愛區', lat: 25.1276, lon: 121.7392, elevation: 10 },
  '基隆市': { datasetId: 'F-D0047-051', county: '基隆市', township: '仁愛區', lat: 25.1276, lon: 121.7392, elevation: 10 },
  '基隆港': { datasetId: 'F-D0047-051', county: '基隆市', township: '仁愛區', lat: 25.1320, lon: 121.7430, elevation: 5 },
...
const KNOWN_COORDINATES: Record<string, { lat: number; lon: number }> = {
  ...
  '宮古島': { lat: 24.8055, lon: 125.2811 },
  'miyakojima': { lat: 24.8055, lon: 125.2811 },
  'miyako': { lat: 24.8055, lon: 125.2811 },
  '石垣島': { lat: 24.3448, lon: 124.1572 },
  '石垣': { lat: 24.3448, lon: 124.1572 },
  '石垣市': { lat: 24.3448, lon: 124.1572 },
  'ishigaki': { lat: 24.3448, lon: 124.1572 },
  '基隆港': { lat: 25.1320, lon: 121.7430 },
